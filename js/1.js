      ...
      !(function (t, n) {
        ...
        !(function () {
          ...
          function ue(e) {
            ...
            return r != u && 9 === r.nodeType && r.documentElement
              ? ((l = (u = r).documentElement),
                (f = !S.isXMLDoc(u)),
                (h =
                  l.matches || l.webkitMatchesSelector || l.msMatchesSelector),
                l.msMatchesSelector &&
                  O != u &&
                  (n = u.defaultView) &&
                  n.top !== n &&
                ...
                (k = function (e, t) {
                  ...
                  return (
                    ...
                    (!v.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === u || (e.ownerDocument == O && Z.contains(O, e))
                        ? -1
                        : t === u || (t.ownerDocument == O && Z.contains(O, t))
                        ? 1
                        : i
          ...
          function ye(e, n) {
            var i,
              ...
              s = T[e + " "];
            if (!s) {
              for (n || (n = ce(e)), i = n.length; i--; )
                (s = ve(n[i]))[y] ? o.push(s) : a.push(s);
              (s = T(
                e,
                (function (e, n) {
                  var i = n.length > 0,
          ...
          function me(e, n, r, i) {
            ...
            if (((r = r || []), 1 === p.length)) {
              if (
                ...
                if (!(n = (t.find.ID(s.matches[0].replace(Y, J), n) || [])[0]))
                  return r;
            ...
            function (e, t) {
              S.fn[e] = function (n, r) {
                ...
                return (
                  ...
                  this.length > 1 &&
                    (z[e] || S.uniqueSort(i), _.test(e) && i.reverse()),
                  this.pushStack(i)
                );
              };
            }
              ...
              var t = [
                ...
                i = {
                  ...
                  then: function (e, r, i) {
                    ...
                    return S.Deferred(function (n) {
                      t[0][3].add(a(0, n, y(i) ? i : V, n.notifyWith)),
                        t[1][3].add(a(0, n, y(e) ? e : V)),
                        t[2][3].add(a(0, n, y(r) ? r : G));
                    }).promise();
                  },
                  promise: function (e) {
        ...
        (S.fn.ready = function (e) {
          ...
          S.extend({
            ...
            ready: function (e) {
              (!0 === e ? --S.readyWait : S.isReady) ||
                ((S.isReady = !0),
                (!0 !== e && --S.readyWait > 0) || Q.resolveWith(x, [S]));
            },
          }),
          (S.ready.then = Q.then),
          ...
          ("loading" !== x.readyState && !x.documentElement.doScroll)
            ...
            : (x.addEventListener("DOMContentLoaded", K),
        ...
        function qe(e, t, n, r, i) {
          ...
          for (f.textContent = "", d = 0; (o = p[d++]); )
            if (r && S.inArray(o, r) > -1) i && i.push(o);
              ...
              ((l = ge(o)), (a = Ae(f.appendChild(o), "script")), l && De(a), n)
            )
              ...
              S.event.add(e, t, {
                ...
                handler: function (e) {
                  ...
                  if (1 & e.isTrigger && this[t]) {
                    ...
                    r &&
                      (ae.set(this, t, S.event.trigger(r[0], r.slice(1), this)),
                      e.stopPropagation(),
          ...
          special: {
            ...
            click: {
              ...
              trigger: function (e) {
                var t = this || e;
                return (
                  Se.test(t.type) && t.click && E(t, "input") && Me(t, "click"),
                  !0
                );
              },
              _default: function (e) {
        ...
        function _e(e, t) {
          ...
          if (1 === t.nodeType) {
            ...
            se.hasData(e) &&
              ((o = se.access(e)), (a = S.extend({}, o)), se.set(t, a));
          }
        }
        function ze(e, t) {
        ...
        function Xe(e, t, n, r) {
          ...
          if (
            p &&
            ((o = (i = qe(t, e[0].ownerDocument, !1, e, r)).firstChild),
            1 === i.childNodes.length && (i = o),
            o || r)
          ) {
            for (s = (a = S.map(Ae(i, "script"), $e)).length; f < p; f++)
              (l = i),
                f !== d &&
                  ((l = S.clone(l, !0, !0)), s && S.merge(a, Ae(l, "script"))),
                n.call(e[f], l, f);
            if (s)
              for (
                ...
                (l = a[f]),
                  Ee.test(l.type || "") &&
                    ...
                    (l.src && "module" !== (l.type || "").toLowerCase()
                      ...
                      : w(l.textContent.replace(We, ""), l, c));
          }
          return e;
        }
        function Ue(e, t, n) {
        ...
        S.extend({
          ...
          clone: function (e, t, n) {
            ...
            if (
              ...
              for (a = Ae(s), r = 0, i = (o = Ae(e)).length; r < i; r++)
                ze(o[r], a[r]);
            if (t)
              if (n)
                for (
                  o = o || Ae(e), a = a || Ae(s), r = 0, i = o.length;
                  r < i;
                  r++
                )
                  _e(o[r], a[r]);
            ...
            return (
              (a = Ae(s, "script")).length > 0 && De(a, !u && Ae(e, "script")),
              s
            );
          },
        ...
        function ut(e, t, n, r, i, o) {
          ...
          for (; a < 4; a += 2)
            "margin" === n && (l += S.css(e, n + de[a], !0, i)),
              r
                ? ("content" === n && (u -= S.css(e, "padding" + de[a], !0, i)),
                  "margin" !== n &&
                    (u -= S.css(e, "border" + de[a] + "Width", !0, i)))
                : ((u += S.css(e, "padding" + de[a], !0, i)),
                  "padding" !== n
                    ? (u += S.css(e, "border" + de[a] + "Width", !0, i))
                    : (s += S.css(e, "border" + de[a] + "Width", !0, i)));
          return (
            !r &&
              o >= 0 &&
              (u +=
        ...
        function xt(e, t, n) {
          ...
          for (
            ...
            if ((r = xt.prefilters[o].call(l, e, c, l.opts)))
              return (
                y(r.stop) &&
        ...
        S.extend(S.event, {
          trigger: function (e, t, r, i) {
            ...
            if (
              ...
              if (!i && !f.noBubble && !m(r)) {
                for (
                  u = f.delegateType || g, qt.test(u + g) || (a = a.parentNode);
                  a;
                  a = a.parentNode
                )
                  h.push(a), (s = a);
              ...
              d.hasContent
                ...
                : ((p = d.url.slice(i.length)),
                  d.data &&
                    ...
                    ((i += (Nt.test(i) ? "&" : "?") + d.data), delete d.data),
                  !1 === d.cache &&
                    ((i = i.replace(Ft, "$1")),
                    (p = (Nt.test(i) ? "&" : "?") + "_=" + Dt.guid++ + p)),
                  (d.url = i + p)),
              d.ifModified &&
                (S.lastModified[i] &&
        ...
        S.ajaxSetup({
          ...
          S.each(["top", "left"], function (e, t) {
            S.cssHooks[t] = Ze(v.pixelPosition, function (e, n) {
              if (n)
                return (
                  (n = Ke(e, t)), Ve.test(n) ? S(e).position()[t] + "px" : n
                );
            });
          }),
          S.each(
        ...
        return (
          (S.noConflict = function (e) {
            return (
              n.$ === S && (n.$ = on), e && n.jQuery === S && (n.jQuery = rn), S
            );
          }),
